...
# Now we partition our iris dataset into a training set L and U. We first specify our training set L consisting of
# 3 random examples. The remaining examples go to our “unlabeled” pool U.
# -----------------------------------------------------------------------------------------
...
# Now, we tune our classifier by allowing it to query 20 instances it hasn’t
# seen before. Using uncertainty sampling
# -----------------------------------------------------------------------------------------
